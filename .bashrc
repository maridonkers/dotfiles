...
# TODO Handled elsewhere on NixOS
# Include secrets
#if [ -r ~/.bashrc_secrets ]
#then
#    . ~/.bashrc_secrets 
...
alias config='GIT_SSH_COMMAND="ssh -i ~/.ssh/codeberg" git --git-dir=/home/mdo/.cfg/ --work-tree=/home/mdo'
...
alias security="w3m https://discourse.nixos.org/c/announcements/security"
...
alias es-rtve="mpv https://www.youtube.com/@rtvenoticias/live &"
