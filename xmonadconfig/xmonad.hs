...
myWorkspaces =
  ...
  where
    clickable l =
      [ "<action=xdotool key super+" ++ show n
          ++ ">"
          ++ "<fn=2>"
          ++ ws
          ++ "</fn>"
...
keysAdditional =
  [("M-q", spawn "xmonad --recompile && xmonad --restart"),
    ...
    ("M-. s r", spawn "mpv --no-terminal https://www.youtube.com/@rtvenoticias/live"), -- rtve
    ...
    ("M-C-S-<Scroll_lock>", spawn $ myScreensaver <> " & systemctl hibernate -i"),
            ...
            dynamicLogWithPP
              xmobarPP
                { ppOutput = \x -> hPutStrLn xmproc0 x >> hPutStrLn xmproc1 x, -- >> hPutStrLn xmproc2 x
                  ...
                  ppTitle = xmobarColor "#ffffff" "" . shorten 20, -- Title of active window in xmobar
